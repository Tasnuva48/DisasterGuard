...
public class SearchAdminFrame extends SearchFrameBase {
    ...
    public SearchAdminFrame(JDesktopPane desktop) {
        super();
        ...
        // Hide and disable View button at startup
    ...
    protected void performSearch(String query) {
        ...
        try {
            ...
            if (model.getRowCount() == 0) {
                JOptionPane.showMessageDialog(this, "No admin found for: " + query);
            }
...
protected void performSearch(String query) {
    ...
    List<UserSearchResult> list = dao.searchUsers("admin_info", query);
    ...
    protected void openSelectedProfile() {
        ...
        AdminProfileFrame profileFrame = new AdminProfileFrame(desktop, username, false);

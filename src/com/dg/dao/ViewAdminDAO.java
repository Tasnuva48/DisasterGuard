...
public class ViewAdminDAO {

    
    public List<ViewAdmin> getAdmins(String statusFilter) {
        List<ViewAdmin> list = new ArrayList<>();
    ...
    /*
    public boolean updateAdminsStatus(List<Integer> ids, List<String> names, List<String> usernames, String newStatus) {
        ...
        try {
            ...
            String sqlUpdate = "UPDATE admin_info SET status = ? WHERE id = ?";
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                if ("Approved".equalsIgnoreCase(newStatus)) {
                    ...
                    pstInsert.setString(3, generateRandomPassword(8));
                    pstInsert.setString(4, "Admin");
...
*/
    public boolean updateAdminsStatus(List<Integer> ids, List<String> names, List<String> usernames, String newStatus) {
        ...
        try {
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                // ✅ If approved → insert into users + send email
                if ("Approved".equalsIgnoreCase(newStatus)) {
                    ...
                    AlertStatusDAO asd=new AlertStatusDAO();
                    asd.insertStatusForNewApprovedAdmin(conn,usernames.get(i));
    ...
    private String getEmailByUsername(Connection conn, String username) {
        String email = null;
        String sql = "SELECT email FROM admin_info WHERE username = ?";
